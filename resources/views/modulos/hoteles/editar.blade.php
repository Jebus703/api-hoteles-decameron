            ...
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    <div class="card-header .bg-white">
                        <h3 class="text-primary">Editar Hotel</h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $errors->has('nombre') ? '' : old('nombre',$hotel->nombre) }}">
                                    @error('nombre')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old('direccion',$hotel->direccion) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old('ciudad',$hotel->ciudad) }}"
                            ...
                            <div class="mb-3">
                                ...
                                value="{{ $errors->has('nit') ? '' : old('nit',$hotel->nit) }}">
                                    @error('nit')
                                        <p class="invalid-feedback">{{ $message }}</p>
                                    @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ old('cantidad',$hotel->max_habitaciones) }}"
